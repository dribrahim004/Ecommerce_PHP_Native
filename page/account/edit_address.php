					...
					<h4 class="black-w3ls">Ubah <span>Alamat</span></h4>


                <?php
                	$db = new database(1);
                	$sql = "SELECT * FROM alamat WHERE md5(id_alamat) ='". $_GET['id'] ."'";
                	$dataP = $db->selectOne($sql);
                	//echo $sql;
                ?>
                
				<form action="aksi.php?module=alamat&act=edit" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                    ...
                    <input id="alamat_sebagi" name="alamat_sebagi" type="text" placeholder="Rumah, Kantor, Kost, atau lain-lain" class="form-control input-md" required=""
                            value="<?php echo $dataP['alamat_sebagi']; ?>" >  
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                    ...
                    <input id="nama_penerima" name="nama_penerima" type="text" class="form-control input-md" required=""
                        value="<?php echo $dataP['nama_penerima']; ?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">                     
                    ...
                    <textarea class="form-control" id="alamat" name="alamat" style="width:330px"><?php echo $dataP['alamat']; ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    ...
                    <h6><br><font color="red">*pilih kembali data Provinsinya jika ada perubahan</font></h6>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    ...
                    <h6><br><font color="red">*pilih kembali data Kota/Kabupatennya jika ada perubahan</font></h6>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                      ...
                      <h6><br><font color="red">*pilih kembali data Kecamatannya jika ada perubahan</font></h6>
